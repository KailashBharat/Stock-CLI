...
var IncomeStatement = /** @class */ (function (_super) {
    __extends(IncomeStatement, _super);
    function IncomeStatement(option) {
        var _this = _super.call(this, option) || this;
        _this.reports = [];
        return _this;
    }
    IncomeStatement.prototype.getUserData = function () {
        var _this = this;
        var _a;
        var result = [];
        if (this.option.search("last") >= 0) {
            result = (_a = this.reports) === null || _a === void 0 ? void 0 : _a.splice(0, parseInt(this.value));
        }
